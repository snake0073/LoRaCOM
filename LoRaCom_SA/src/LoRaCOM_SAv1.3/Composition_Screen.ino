...
//Receives incoming message from serial keyboard and encodes it for transmission from RYLR896 LoRa module//
        ...
        display.fillRect(0,0,128,55,BLACK);
        display.fillRect(0,0,103,64,BLACK);
...
void composeScreen(){                //displayed at the bottom of each chat screen for a quick reply option
